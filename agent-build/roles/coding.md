...
3. 让开发角色在隔离 worktree 内实现；Coding 只调度、协调和收集结果，禁止直接写产品代码。
...
6. 让 Git Operator 按授权范围提交、按依赖从最新 integration commit 派生、无 `--ff` 合并和清理；冲突内容由对应开发代理解决后由 Git Operator 继续 merge。
