...
- 读取范围：`src/state.ts`、`src/dispatch/planning.ts`、`src/dispatch.ts`
- 写入范围：`src/state.ts`、`src/dispatch/planning.ts`、`test/dispatch/planning-lifecycle.test.ts`、`test/cli/planning.test.ts`
- 允许写入路径：`src/state.ts`、`src/dispatch/planning.ts`、`test/dispatch/planning-lifecycle.test.ts`、`test/cli/planning.test.ts`
- 依赖：无
- 实现步骤：
