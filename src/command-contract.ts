...
export const COMMAND_SYNTAX: Readonly<Record<string, readonly string[]>> = Object.freeze({
  ...
  "git recover-task-worktree": ["ai-team git recover-task-worktree --project <path> --worktree-id <opaque-id> --from-plan-id <plan-id> --from-revision <revision> --to-plan-id <plan-id> --to-revision <revision> --to-run-id <run-id> --task-id <task-id> --expected-head <commit> --expected-source-artifact <artifact-id-or-digest> --dispatch-id <dispatch-id>"],
