...
export const COMMAND_SYNTAX: Readonly<Record<string, readonly string[]>> = Object.freeze({
  ...
  "dispatch recover-claimed-task-scope": ["ai-team dispatch recover-claimed-task-scope --run-id <run-id> --dispatch-id <dispatch-id> --role <role> --authority-commit <sha> --expected-head <sha> --add-write-path <path...>"],
  "dispatch repair-claimed-task-scope-replacement": ["ai-team dispatch repair-claimed-task-scope-replacement --run-id <run-id> --dispatch-id <dispatch-id>"],
...
const AGENT_COMMANDS = ["context update", "context validate", "planning revision validate", "planning revision create", "planning revision transition", "planning revision commit", "planning tasks validate", "dispatch create", "dispatch claim", "dispatch cancel", "dispatch reissue", "dispatch reconcile", "dispatch supersede", "dispatch recover-claimed-task-scope", "dispatch repair-claimed-task-scope-replacement", "dispatch prompt", "dispatch schema", "dispatch template", "dispatch packet-schema", "dispatch packet-template", "dispatch validate", "dispatch submit", "decision create", "decision schema", "decision template", "staging create", "staging write", "staging show", "staging cleanup", "scope check", "git status", "git prepare", "git adopt", "git transfer", "git recover-task-worktree", "git apply-task-authority", "git continue-authority-conflict", "git commit", "git merge-task", "git integrate", "git reconcile", "git cleanup", "research archive", "review create", "review submit", "review resolution-schema", "review resolution-template", "review resolve", "review status"] as const;
...
export const COMMAND_VALIDATORS: Readonly<Record<string, CommandSpec>> = Object.freeze({
  ...
  "dispatch.repair-claimed-task-scope-replacement": { required: ["runId", "dispatchId"], optional: [], patterns: { runId: IDS.runId, dispatchId: IDS.dispatchId }, syntax: COMMAND_SYNTAX["dispatch repair-claimed-task-scope-replacement"]! },
